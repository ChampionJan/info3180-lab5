    ...
    function saveMovie() {
               ...
               .then(function (data) {
                   ...
                   if (Array.isArray(data)){
                       ...
                       console.log(fields);
                       if (fields.includes("description") && !fields.includes("poster") && fields.includes("title")){
                       ...
                       if(fields.includes("poster") && !fields.includes("description") && fields.includes("title")){
